    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 text-slate-500 opacity-70 hover:opacity-100"
        ),
        ...
        day_selected:
          "bg-primary-700 text-white hover:bg-primary-700 hover:text-white focus:bg-primary-700 focus:text-white",
        day_today: "bg-slate-100 text-slate-900 font-semibold",
        day_outside: "text-slate-400 opacity-50 aria-selected:bg-primary-50/50",
